# Day 01 | Development Environment & Git
...
1. Repository (Repo) – Stores the project and its history.
2. Commit – A snapshot of project changes.
3. Branch – A separate line of development.
4. Merge – Combines changes from different branches.
5. Clone – Downloads an existing repository.
6. Push/Pull – Uploads and downloads changes between local and remote repositories.
